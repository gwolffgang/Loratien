 ...
 * over the subintervals determined by the x values,
 * {@code x[0] < x[i] ... < x[n].} The x values are referred to as "knot
 * points."
 * <p>
...
public class SplineInterpolator implements UnivariateInterpolator {
	 ...
	 *                                       different sizes.
	 * @throws NonMonotonicSequenceException if {@code x} is not sorted in strict
	 *                                       increasing order.
	...
	public PolynomialSplineFunction interpolate(double x[], double y[])
		...
		// cubic spline coefficients -- b is linear, c quadratic, d is cubic (original
		// y's are constants)
